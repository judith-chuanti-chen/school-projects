...
public class TaskCoordinatorTest {
  ...
  public void testToString() {
    String expected = "TaskCoordinator{requiredSubForEachMain={}, taskPriority={}, todoList=TodoList{header={due=3, id=0, text=1, completed=2, priority=4, category=5}, todos=[]}, collectedCommands={}, taskList=[], CSVpath='null'}";
